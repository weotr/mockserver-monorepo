...
public class HttpRequestSerializerSchemaValidationTest {
    ...
    public void shouldDeserializeHeaderValueWithSingleValue() {
        ...
        // then
        assertThat( httpRequest, is(new HttpRequest()
            .withHeader("someHeaderName", "someHeaderValue")));
    }
    ...
    public void shouldDeserializeQueryStringParameterValueWithSingleValue() {
        ...
        // then
        assertThat( httpRequest, is(new HttpRequest()
            .withQueryStringParameter("someParameterName", "someParameterValue")));
    }
    ...
    public void shouldDeserializePathParameterValueWithSingleValue() {
        ...
        // then
        assertThat( httpRequest, is(new HttpRequest()
            .withPathParameter("path_someParameterName", "path_someParameterValue")));
    }
    ...
    public void shouldDeserializeJsonBody() {
        ...
        HttpRequest expected = new HttpRequestDTO()
            .setBody(BodyDTO.createDTO(json("{" + NEW_LINE +
                ...
                "}")))
            .buildObject();
        assertThat( httpRequest, is(expected));
    }
