...
How to use MockServer's **interactive breakpoints** from Go to modify a proxied
response in-flight:
...
This is the "modify proxied exchanges" feature: your Go program acts as the
...
4. Sending GET /proxy ...
   ...
   [breakpoint] Modified response body: {"source":"upstream","modified":true,"breakpoint":"go-client"}

--- Response from GET /proxy ---
Status:          200
Body:            {"source":"upstream","modified":true,"breakpoint":"go-client"}
X-Modified-By:   go-breakpoint-example
